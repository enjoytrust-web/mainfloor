...
<div class="breadcrumbs">
  <div class="l-container">
    <a href="<?php home_url();?>/index.php" class="breadcrumbs-link">HOME</a> <span class=""> &gt; </span> <a href="<?php home_url();?>/music/" class="breadcrumbs-link">MUSIC</a>
  </div>
</div>
  ...
  <div class="l-container">
    <div class="l-row">
      ...
      <div clasS="l-grid-8">
        ...
        <?php if (have_posts()) :
          $my_query = new WP_Query('post_type=post&category_name=music&showposts=8'.'&paged='.$paged); /* wp-pagenavi + queryposts連動させる */
