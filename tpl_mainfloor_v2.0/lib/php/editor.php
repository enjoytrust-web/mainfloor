...
?>
    ...
    QTags.addButton( 'youtube-title', '動画タイトル', '<div class="single-post-youtube"><iframe width="853" height="480" src="', '?playsinline=1&showinfo=0" frameborder="0" allowfullscreen class="single-post-youtube-player"></iframe></div>', '', 'YouTube埋め込み', 1 );
